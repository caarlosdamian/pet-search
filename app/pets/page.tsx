  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900">Find Your Perfect Pet</h1>
        <p className="mt-4 max-w-xl text-gray-500">
          Browse our available pets and filter by type, age, and location to find your perfect match.
        </p>
        ...
        <div className="mt-12 grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
          ...
          <div className="lg:col-span-3">
            <Suspense fallback={<PetListSkeleton />}>
              <PetListWithData searchParams={searchParams} />
            </Suspense>
          </div>
        </div>
      </div>
...
async function getPets(params: { [key: string]: string | string[] | undefined }): Promise<Pet[]> {
